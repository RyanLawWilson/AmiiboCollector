...
urlpatterns = [
    ...
    path('Collection/<int:pk>/Edit/', views.edit_jersey, name='jerseyEdit'),       #edit a single jersey
    path('Collection/<int:pk>/Delete/', views.delete_jersey, name='jerseyDelete'), #delete a single jersey
